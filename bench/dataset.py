...
FACTS = [
    ...
    (4,  "f04", "Sahil graduated from the University of Maryland, College Park.", "education"),
    (5,  "f05", "Sahil's favorite programming language is Python.", "fav_language"),
    (6,  "f06", "Sahil drinks coffee every morning.", "drink"),

    (7,  "f07", "Sahil is building Clippy_Vision, a personal AI activity monitor.", "clippy"),
    ...
    (10, "f10", "Sahil added a natural-language time parser to Clippy_Vision.", "clippy"),

    (11, "f11", "Sahil also works on Launchway, a project about agentic workflows and RAG.", "launchway"),
    ...
    (20, "f20", "Sahil's favorite programming language is Python.", "fav_language"),   # exact duplicate of f05
    (21, "f21", "Python is Sahil's preferred language to code in.", "fav_language"),   # paraphrase

    (22, "f22", "Sahil is refactoring the memory distiller in Clippy_Vision.", "clippy"),
    (23, "f23", "While building Clippy_Vision, Sahil benchmarks Ollama models inside Cursor.", "clippy"),  # multi-topic

    (24, "f24", "Sahil recently took up rock climbing on weekends.", "hobby_climbing"),

    # --- later updates that should SUPERSEDE earlier values ---
    (40, "f40", "Sahil moved to San Francisco, California.", "location"),              # supersedes f02
    (45, "f45", "Sahil started a full-time job as an AI engineer at Acme Corp.", "employment"),  # supersedes f03
    (48, "f48", "Sahil quit caffeine and now drinks herbal tea in the morning.", "drink"),       # supersedes f06
]
...
QUERIES = [
    {"id": "q01", "q": "What is Sahil's name?", "grade": "det",
     "expect": ["Sahil"], "forbid": []},
    {"id": "q02", "q": "Where does Sahil live now?", "grade": "det",
     "expect": ["San Francisco"], "forbid": ["College Park, Maryland"]},
    {"id": "q03", "q": "What does Sahil do for work now?", "grade": "judge",
     "expect": ["Acme"], "forbid": ["looking for"], "answer": "AI engineer at Acme Corp"},
    {"id": "q04", "q": "Where did Sahil study?", "grade": "det",
     "expect": ["University of Maryland"], "forbid": []},
    {"id": "q05", "q": "What is Sahil's favorite programming language?", "grade": "det",
     "expect": ["Python"], "forbid": []},
    ...
    {"id": "q09", "q": "What does Sahil drink in the morning now?", "grade": "det",
     "expect": ["tea"], "forbid": ["coffee"]},
    {"id": "q10", "q": "What are Sahil's hobbies?", "grade": "judge",
     "expect": ["chess"], "forbid": [], "answer": "chess and rock climbing"},
    {"id": "q11", "q": "What code editor does Sahil use?", "grade": "det",
     "expect": ["Cursor"], "forbid": []},
    {"id": "q12", "q": "What operating system and shell does Sahil use?", "grade": "det",
     "expect": ["PowerShell"], "forbid": []},
    {"id": "q13", "q": "Does Sahil have any siblings?", "grade": "det",
     "expect": ["Arjun"], "forbid": []},
    {"id": "q14", "q": "How does Sahil like his assistant to respond?", "grade": "judge",
     "expect": ["concise"], "forbid": [], "answer": "concisely"},
    {"id": "q15", "q": "What database does Clippy_Vision use?", "grade": "det",
     "expect": ["SQLite"], "forbid": []},
]
